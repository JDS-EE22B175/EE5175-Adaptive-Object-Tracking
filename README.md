...
![Successful Detection and Tracking](Report/Working Detection.png)<br>
...
<div style="display: flex; justify-content: center;">
  <figure style="text-align: center; margin: 10px;">
    <img src="Report/Basketball Tracking.png" width="384">
    <figcaption><em>Successful ball tracking in `BB.mp4` ('all' mode)</em></figcaption>
  </figure>
  <figure style="text-align: center; margin: 10px;">
    <img src="Report/BB Tracked1.jpg" width="384">
...
<div style="display: flex; justify-content: center;">
  <figure style="text-align: center; margin: 10px;">
    <img src="Report/Occlusion (2).png" width="384">
  </figure>
  <figure style="text-align: center; margin: 10px;">
    <img src="Report/Occlusion (1).png" width="384">
...
<div style="display: flex; justify-content: center;">
  <figure style="text-align: center; margin: 10px;">
    <img src="Report/OcclusionF (2).png" width="384">
  </figure>
  <figure style="text-align: center; margin: 10px;">
    <img src="Report/OcclusionF (1).png" width="384">
